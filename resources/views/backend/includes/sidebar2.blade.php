        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="{{url('admin/users')}}">
                <i class="fa fa-users"></i>
                <span>Book Management</span><i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="{{url('admin/books')}}"><i class="fa fa-circle-o"></i> List Book</a></li>
                <li><a href="{{url('admin/books/create')}}"><i class="fa fa-circle-o"></i> Add New Book</a></li>
              </ul>
            </li>
